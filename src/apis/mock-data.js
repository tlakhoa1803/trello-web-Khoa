export const mockData = {
  board: {
    ...
    columnOrderIds: ['column-id-01', 'column-id-02', 'column-id-03', 'column-id-04-placeholdercard'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover: 'https://staticg.sportskeeda.com/editor/2022/01/9441c-16419200856280-1920.jpg?w=640',
            memberIds: ['test-user-id-01'],
            comments: ['test comment 01', 'test comment 02', 'test attachment 03'],
            attachments: ['test attachment 01', 'test attachment 02', 'test attachment 03', 'test attachment 03']
          },
      ...
      },
      {
        ...
        cards: [
          { _id: 'card-id-111', boardId: 'board-id-01', columnId: 'column-id-04-placeholdercard', FE_PlaceholderCard: true }
        ]
      }
    ]
  }
